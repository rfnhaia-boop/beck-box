                                ...
                                <>
                                    {hasAccess ? (
                                        ...
                                        <div className="p-8 rounded-2xl bg-[#A855F7]/10 border border-[#A855F7]/30 text-center relative overflow-hidden group">
                                            ...
                                            <Link
                                                href="/#pricing"
                                                className="inline-block w-full py-3 rounded-xl bg-[#A855F7] text-white font-bold uppercase tracking-widest hover:bg-[#9333ea] transition-colors shadow-[0_0_20px_rgba(168,85,247,0.4)]"
                                            >
                                                Desbloquear Acesso
                                            </Link>
                                        </div>
