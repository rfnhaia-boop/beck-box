...
export const FuturisticBackground = () => {
    ...
    return (
        ...
        >
            {/* GRID SUPREMO - Opacidade reduzida para evitar ruído visual */}
            <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-[0.1]" xmlns="http://www.w3.org/2000/svg">
                <defs>
